...
namespace asc_general.Controllers
{
    public class Health_Staff_CrudController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Create([Bind(Include = "id,name,profession,photo,text_about,facebook,intagram")] health_staff health_staff, HttpPostedFileBase photo)
        {
        ...
        public ActionResult Create2([Bind(Include = "id,name,profession,photo,text_about,instagram,facebook")] health_staff health_staff)
        {
        ...
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        public ActionResult Edit([Bind(Include = "id,name,profession,photo,text_about,instagram,facebook")] health_staff health_staff, string oldfile)
        {
