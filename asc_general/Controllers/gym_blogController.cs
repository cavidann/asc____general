...
namespace asc_general.Controllers
{
    public class gym_blogController : Controller
    {
        ...
        public ActionResult Create2 ([Bind(Include = "id,title,photo,description,text")] gym_blog gym_blog)
        {
        ...
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        public ActionResult Edit([Bind(Include = "id,title,photo,text,video_url")] gym_blog gym_blog, string oldfile)
        {
